# 📊 Project 2: Analytics Dashboard Queries

Viết các queries phức tạp để tạo analytics dashboard cho e-commerce.

## 🎯 Mục Tiêu Project

Sau khi hoàn thành project này, bạn sẽ:
- ✅ Viết complex queries với JOINs & Subqueries
- ✅ Sử dụng Aggregate Functions & GROUP BY
- ✅ Tạo views cho dashboard
- ✅ Tối ưu hóa queries
- ✅ Hiểu data analysis patterns
...
SELECT 
  ...
  DATEDIFF(day, MAX(o.created_at), CURRENT_DATE) AS days_since_purchase
FROM users u
LEFT JOIN orders o ON u.id = o.user_id
...
#### 3.3 Product Rating Distribution
```sql
...
#### 4.3 Orders with Multiple Items
```sql
...
- [ ] Task 1: Viết Sales Analytics queries
- [ ] Task 2: Viết Customer Analytics queries
- [ ] Task 3: Viết Product Analytics queries
- [ ] Task 4: Viết Order Analytics queries
- [ ] Task 5: Tạo Dashboard Views
- [ ] Task 6: Tối ưu hóa queries
- [ ] Task 7: Tạo reports
...
- ✅ Complex queries với JOINs & Subqueries
